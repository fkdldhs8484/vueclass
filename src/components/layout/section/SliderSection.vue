...
.silder__img {
  background: url(/src/assets/img/SLIDER_TYPE01_01.jpg) no-repeat center / cover;
}
.silder__img .desc {
  width: 1160px;
  margin: 0 auto;
...
.slider__arrow a {
  ...
  width: 30px;
  height: 56px;
  background: url(/src/assets/img/slider_icon.svg);
...
.slider__dot a {
  ...
  width: 16px;
  height: 16px;
  background-image: url(/src/assets/img/slider_icon.svg);
}
...
.swiper-pagination-bullet {
  ...
  background-image: url(/src/assets/img/slider_icon.svg) !important;
