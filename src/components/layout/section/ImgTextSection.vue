  ...
  <section id="imgTextType" class="imgText__wrap" :class="attr">
    ...
    <div class="imgText__inner" :class="layout">
      <div class="imgText__txt">
        ...
        <h3>유용한 사이트 살펴보기</h3>
        <p>
          웹디자이너, 웹 퍼블리셔, 프론트앤드 개발자를 위한 유용한 사이트입니다.
        </p>
        <ul>
...
.imgText__img.img1 {
  background: url(/src/assets/img/imgText_bg01.jpg) no-repeat center / cover;
}
.imgText__img.img2 {
  background: url(/src/assets/img/imgText_bg02.jpg) no-repeat center / cover;
}
